...
<body class="bg-darkbg text-white font-base font-body">
    ...
    <section id="hero" class="relative min-h-screen mobile-hero-section flex flex-col lg:block overflow-hidden">
        ...
        <header id="mainHeader" class="fixed top-0 left-0 right-0 z-[60] transition-all duration-500">
            <div class="max-w-[1600px] mx-auto px-6 md:px-10 py-5 md:py-6 flex items-center justify-between">
                ...
                <nav
                    class="hidden lg:flex items-center gap-10 text-gray-300 font-medium text-sm uppercase tracking-widest">
        ...
        <div class="relative flex overflow-x-hidden group">
            <div class="flex animate-marquee gap-8 items-center group-hover:[animation-play-state:paused]">
                <div class="flex items-center gap-8">
                    <a href="#"
                        class="text-white/90 font-medium text-xs md:text-sm hover:text-white transition-colors whitespace-nowrap">
    ...
    <div id="video-modal"
        ...
        <div class="relative w-full max-w-4xl aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl">
            ...
            <iframe id="video-iframe" class="w-full h-full" src="" frameborder="0" allow="autoplay; fullscreen"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
                ...
                <div class="space-y-6">
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed max-w-sm">
                        Leading UK-qualified solicitors providing expert immigration and legal solutions with integrity
                        and a focus on client success.
                    </p>
                    <div class="flex items-center gap-4 pt-2">
                        <a href="#"
                            class="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-primary hover:border-primary transition-all duration-300">
