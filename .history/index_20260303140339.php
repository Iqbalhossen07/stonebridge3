        ...
        <div class="max-w-[1600px] mx-auto px-6 md:px-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <div class="relative group p-[2px] rounded-2xl overflow-hidden h-full cursor-pointer bg-white/5"
                    ...
                    <div
                        class="absolute inset-[-1000%] animate-[spin_6s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#b48a3e_0%,#1a1a1a_50%,#b48a3e_100%)] opacity-40">
                    </div>

                    <div
                        class="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#ffffff_0%,transparent_25%,#b48a3e_50%,transparent_75%,#ffffff_100%)] opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-0">
                    </div>
                ...
                <div class="relative group p-[2px] rounded-2xl overflow-hidden h-full cursor-pointer bg-white/5"
                    ...
                    <div
                        ...
                        <div class="px-4 pb-6">
                            ...
                            <p class="text-gray-400 text-xs line-clamp-2 leading-relaxed">How businesses can maintain
                                their HR systems for Home Office audits.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative group p-[2px] rounded-2xl overflow-hidden h-full cursor-pointer bg-white/5"
                    ...
                    <div
                        ...
                        <div class="px-4 pb-6">
                            ...
                            <p class="text-gray-400 text-xs line-clamp-2 leading-relaxed">Expert insights on handling
                                IAA Level 3 complex asylum representation.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative group p-[2px] rounded-2xl overflow-hidden h-full cursor-pointer bg-white/5"
                    ...
                    <div
                        ...
                        <div class="px-4 pb-6">
                            <h3 class="text-lg font-bold text-white mb-2 group-hover:text-primary transition-colors">
                                Legal Research & Prep</h3>
                            <p class="text-gray-500 text-xs line-clamp-2 leading-relaxed">Behind the scenes of how our
                                solicitors prepare for a high-stakes UK court case.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-16 text-center">
                <a href="#"
                    class="inline-block bg-primary text-white font-bold px-8 py-3.5 rounded-md hover:bg-white hover:text-black transition-all duration-300 shadow-xl shadow-primary/10 text-sm uppercase tracking-widest">
